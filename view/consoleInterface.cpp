...
void view::ConsoleInterface::setupAndStart() {
  int S, I, R, t;
  double beta, gamma;
  ...
  if (file != NULL) {
    ...
    if (answer == "y" || answer == "yes" || answer == "Y" || answer == "Yes") {
      if (6 == std::fscanf(file, "%d %d %d %lf %lf %d", &S, &I, &R, &beta,
                           &gamma, &t)) {
        std::fclose(file);
  ...
  std::cin >> t;
  view::ConsoleInterface::start(S, I, R, beta, gamma, t);
}
void view::ConsoleInterface::start(int S, int I, int R, double beta,
                                   double gamma, int t) {
  ...
  std::cout << SEPARATOR << "Stage count" << SEPARATOR << std::setw(4) << "S"
            << std::setw(5) << SEPARATOR << std::setw(4) << "I" << std::setw(5)
            << SEPARATOR << std::setw(4) << "R" << std::setw(5) << SEPARATOR
            << std::endl;
  std::cout << LINE_SEPARATOR << std::endl;
  do {
    ...
    std::cout << SEPARATOR << std::setw(6) << simulation->getStageCount()
              << std::setw(8) << SEPARATOR << std::setw(4) << s_values.back()
              << std::setw(5) << SEPARATOR << std::setw(4) << i_values.back()
              << std::setw(5) << SEPARATOR << std::setw(4) << r_values.back()
              << std::setw(5) << SEPARATOR << std::endl;
    std::cout << LINE_SEPARATOR << std::endl;
